...
namespace FirstAidChest.Data.Base
{
    public class SqlDatabase
    {
        ...
        public SqlDatabase()
        {
            ...
            dbConnection = ConfigurationManager.ConnectionStrings[1].ConnectionString;
        }
        ...
        public SqlDatabase(Dictionary<String, String> connectionOpts)
        {
            String str = "";
        ...
        public bool ClearDB()
        {
            ...
            try
            {
                tables = this.GetDataTable("select NAME from Sql_MASTER where type='table' order by NAME;");
        ...
        public bool IsTableExists(String tableName)
        {
            ...
            using (SqlConnection cnn = new SqlConnection(dbConnection))
            {
                try
                {
                    ...
                    String sql = string.Format("SELECT COUNT(*) FROM Sql_master WHERE type = 'table' AND name ='{0}'", tableName);
